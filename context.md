...
- Docs now use a proper MkDocs layout: markdown content moved under `docs/docs/`, `docs/mkdocs.yml` points `docs_dir: docs`, and output builds to `public/docs`, fixing the broken docs build that prevented the shadcn theme's code-copy buttons from appearing on deployed docs.
